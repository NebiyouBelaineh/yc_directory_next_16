...
// Variable: STARTUPS_VIEWS_BY_ID
// Query: *[_type == "startup" && _id == $id][0] {  _id,  views,  }
export type STARTUPS_VIEWS_BY_IDResult = {
  _id: string;
  views: number | null;
} | null;
// Variable: AUTHOR_BY_USER_ID
// Query: *[_type == "author" && _id == $id][0] {  _id,  id,  name,  username,  email,  image,  bio  }
export type AUTHOR_BY_USER_IDResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
...
// Variable: AUTHOR_BY_PROVIDER_ID
// Query: *[_type == "author" && provider == $provider && providerId == $providerId][0] {    _id,    id,    name,    username,    email,    image,    bio,    provider,    providerId  }
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc, views desc) {  _id,  title,  slug,  _createdAt,  author -> {    _id,    name,    image,    bio,    username  },  views,  description,  category,  image,  pitch,  _type,  _updatedAt,  _rev}
